...
def shrukin( host, port, sys_table_address, debug ):
    ...
    testing. I have not tested it with any other configuration of BitLocker as of the creation of 
    this following date: 6/20/2013 @ 8:52 PM
    """
    ...
    if dev != None:
        ...
        pcie_lib_helper.inject_efi_staged( dev, sys_table_address, stage_1_c, retry_wait = 0.01 )
    else:
